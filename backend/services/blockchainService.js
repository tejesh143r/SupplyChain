...
function initBlockchain() {
  ...
  const rpcUrl = process.env.RPC_URL || (isProduction ? null : 'http://127.0.0.1:8545');
  const privateKey = process.env.PRIVATE_KEY || (isProduction ? null : '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80');
